...
let s:colors = {
      ...
      \ "light_red": get(s:overrides, "light_red", { "gui": "#f07178", "cterm": "204", "cterm16": "1" }),
      \ "dark_red": get(s:overrides, "dark_red", { "gui": "#be5046", "cterm": "196", "cterm16": "9" }),
      \ "bg_red": get(s:overrides, "bg_red", { "gui": "#553333", "cterm": "88", "cterm16": "0" }),
      \ "green": get(s:overrides, "green", { "gui": "#c3e88d", "cterm": "114", "cterm16": "2" }),
      \ "bg_green": get(s:overrides, "bg_green", { "gui": "#335533", "cterm": "22", "cterm16": "0" }),
      ...
      \ "bg_blue": get(s:overrides, "bg_blue", { "gui": "#444477", "cterm": "18", "cterm16": "0" }),
      \ "ref_blue": get(s:overrides, "ref_blue", { "gui": "#344466", "cterm": "18", "cterm16": "0" }),
